...
1. Go to https://api.nasa.gov/ and get yourself an API key. This'll be important later. 
2. Go to https://app.codingrooms.com/ and make/log into an account
3. Next, click on workspaces and make a new workspace in python 3
4. Open the workspace, copy and paste the code from asteroid.py to there
5. On line 28, you will see DEMO_KEY. (You can search for 'demo' with ctrl f)
6. Once you have found DEMO_KEY, you can either keep it there, or, as I recommend, copy and paste your own API key from step 1 in place of DEMO_KEY.
7. Click run, and the program (should) work perfectly fine!
Again, I am very sorry for the errors. This was unaticipated and will be dealt with ASAP.
